<template>
  <div class="product">
    ...
    <div class="select">
      <el-input v-model="list.name" clearable placeholder="请输入产品名称" />
      <div class="btn">
    ...
    <el-dialog :title="title" :visible.sync="dialogFormVisible">
      <el-form ref="ruleForm" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="价格" prop="price">
          <el-input v-model="form.price" clearable placeholder="请输入价格" />
        </el-form-item>
        ...
        <el-form-item label="介绍" prop="description">
          <el-input v-model="form.description" type="textarea" clearable placeholder="请输入产品介绍" />
        </el-form-item>
        <div class="upload">
          <el-upload
             class="upload-demo"
            action="http://203.195.133.117:6666/file/upload"
          ...
          <!-- <el-upload
            class="upload-demo"
            action="http://203.195.133.117:5588/file/upload"
            :on-preview="handlePreview"
            :on-remove="handleRemove"
