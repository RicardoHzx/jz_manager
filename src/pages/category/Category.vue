<template>
    <div class="category">
        ...
        <div class="select">
            <el-input  v-model="list.name" clearable placeholder='请输入栏目名称'></el-input>
            <div class='btn'>
        ...
        <el-table-column align='center' prop="name" label="栏目名称"></el-table-column>
        <el-table-column align='center' prop="num" label="序号"></el-table-column>
        <el-table-column align='center' prop="parentId" label="父栏目"></el-table-column>
        ...
        <el-form :model="form" :rules="rules" ref="ruleForm" label-width="120px">
            ...
            <el-input v-model="form.num" clearable placeholder='请输入序号'></el-input>
            </el-form-item>
